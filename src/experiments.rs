...
fn best_diabetes() {
    //funker uten f1 score, får 76-77 consistent
    ...
    let mut params =  if false{
        ...
        Params {
            ...
            boost: 0,
            // -- train params -- //
            antigen_pop_size: PopSizeType::Fraction(1.3),
    ...
    if true {
        ...
        for n in 0..10{
            ...
            ais_n_fold_test(params.clone(), antigens.clone(), &VerbosityParams::n_fold_defaults(), 3, translator.clone() ,&mut logger);
        }
        logger.log_multi_run_acc()
    }
